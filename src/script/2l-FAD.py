...
class LoadTrainDataset(Dataset):
    ...
    def __getitem__(self, ix):
        ...
        """if self.train:
            waveform = random.choice(self.resamples)(waveform)
            waveform = self.norm_5sec(waveform)
        """
...
class cnn_audio(nn.Module):
    def __init__(self, 
        ...
        #self.conv1_2 = nn.Conv2d(64, 128, kernel_size=(3, 3), stride=(1, 1))
        self.bn1 = nn.BatchNorm2d(64)
        self.relu = nn.ReLU(0.1)
        self.maxpool = nn.AvgPool2d(kernel_size=3, stride=3)
        self.dropout = nn.Dropout(0.1)

        self.conv2 = nn.Conv2d(64, 128, kernel_size=(3, 3), stride=(1, 1))
        #self.conv2_2 = nn.Conv2d(256, 512, kernel_size=(3, 3), stride=(1, 1))
        self.bn2 = nn.BatchNorm2d(128)
        self.relu2 = nn.ReLU(0.1)
        self.maxpool2 = nn.AvgPool2d(kernel_size=3, stride=3)
        self.dropout2 = nn.Dropout(0.1)
        
        self.conv3 = nn.Conv2d(128, 256, kernel_size=(3, 3), stride=(1, 1))
        #self.conv3_2 = nn.Conv2d(1024, 1024, kernel_size=(3, 3), stride=(1, 1))
        self.bn3 = nn.BatchNorm2d(256)
        self.relu3 = nn.ReLU(0.1)
        self.maxpool3 = nn.AvgPool2d(kernel_size=3, stride=3)
        ...
        self.relu_out2 = nn.ReLU(0.1)
        self.dropout_out2 = nn.Dropout(0.1)
        self.output3 = nn.Linear(512, output_class)
...
fh = logging.FileHandler('../../logs/err_log_2k.log')
...
try:        
    ...
    train_dataset = LoadTrainDataset(train_data, folder, False)
    test_dataset = LoadTrainDataset(test_data, folder, False)

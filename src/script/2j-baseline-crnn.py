...
class cnn_audio(nn.Module):
    def __init__(self, 
        ...
        self.conv2 = nn.Conv2d(128, 256, kernel_size=(3, 3), stride=(1, 1))
        ...
        self.conv3 = nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1))
...
try:        
    ...
    with open('../../dataset/test_datak5.pickle', 'rb') as f:

...
class cnn_audio(nn.Module):
    def __init__(self, 
        ...
        self.output2 = nn.Linear(128, output_class)
...
class Trainer():
    ...
    def save(self, epoch, file_path="../models/2i/"):
        """
        """
    ...
    def export_log(self, epoch, file_path="../../logs/2i/"):
        df = pd.DataFrame({
...
fh = logging.FileHandler('../../logs/err_log_2i.log')
